...
void tabulate(void)
{
    ...
    for (int i = 0; i < voter_count; i++)
    {
        // Set number of votes casted by voter i to zero
        int votes_casted = 0;

        // Loop over all preferences by voter i
        for (int j = 0; j < candidate_count; j++)
        {
...
int find_min(void)
{
    ...
    // Set min to maximum number of votes that can be received
    int min = voter_count;

    // Find minimum of votes received by a candidate
    for (int i = 0; i < candidate_count; i++)
    {
...
bool is_tie(int min)
{
    // Check if minimum number of votes is received by all non-eliminated candidates
    for (int i = 0; i < candidate_count; i++)
    {
